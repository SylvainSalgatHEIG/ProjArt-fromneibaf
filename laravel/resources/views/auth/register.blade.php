            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="groupName" class="col-md-4 col-form-label text-md-end">{{ __('Group name') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="groupPwd" class="col-md-4 col-form-label text-md-end">{{ __('Group password') }}</label>

                            <div class="col-md-6">
                                <input id="groupPwd" type="text" class="form-control @error('groupPwd') is-invalid @enderror" name="groupPwd" value="{{ old('groupPwd') }}" required autocomplete="groupPwd" autofocus>
